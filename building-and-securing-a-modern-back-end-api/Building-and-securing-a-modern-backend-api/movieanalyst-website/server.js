...
var NON_INTERACTIVE_CLIENT_ID = 'FAqVo6Bo4L6PeWBOjtQx8RxYH26P4jPy';
var NON_INTERACTIVE_CLIENT_SECRET = 'DA_Amtx4f6umnv-ygDyVh_MG80l-AnE6yJF3j8XOLUJMXD3YVLTkP49NDXM0B4WQ';
...
function getAccessToken(req, res, next){
  request
    .post('https://devlogger.auth0.com/oauth/token')
    .send(authData)
